...
export default {
  ...
  computed: {
    propertyData() {
      return this.$store.state.feeds["PropertyList"]["/Sale/ALL/ALL/ALL/61/N/ALL/ALL/ALL/ALL/ALL/ALL"];
    },
    Properties() {
  ...
  fetch({ store }) {
    return store.dispatch("FETCH_FEED", {feed: "PropertyList",filters:"/Sale/ALL/ALL/ALL/61/N/ALL/ALL/ALL/ALL/ALL/ALL"})
    .then(res => {return store.dispatch("FETCH_FEED", {feed: "BuildingList",filters: "/ALL/ALL/" + config.websiteId + "/ALL/Villa/ALL"});
    });
  },
   head() {
    return {
      title: `Villas & Houses for Sale in Dubai - Dubai Villas`,
      meta: [
        {
          hid: "og:title",
          name: "og:title",
          property: "og:title",
          content: `Villas & Houses for Sale in Dubai - Dubai Villas`
        },
        {
          hid: "og:description",
          name: "og:description",
          property: "og:description",
          content:`Villas are available for sale in Dubai. Find out all the details including a payment plan, prices, floor plans, exclusive images. Contact us now & book your viewing.`
        },
        {
          hid: "og:site_name",
          name: "og:site_name",
